...
df2.plot(x='Date', y=['Product_A', 'Product_B', 'Product_C'], title='Sales Trends')
plt.ylabel('Sales')
plt.tight_layout()
plt.show()
...
department_counts.plot(kind='bar', title='Employees per Department')
...
#Exercise 4: Pie chart - sales distribution per product
